---
{"dg-publish":true,"permalink":"/02_Javascript/ES6/","created":"2025-08-12T09:22:34.405+08:00","updated":"2025-10-09T17:08:19.789+08:00"}
---
...
| [Array.prototype.fill(n)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/fill)            | 将数组的某些项设置为n                       | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-13.png) |
| [Array.prototype.forEach(fn)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach)     | 遍历数组，传入一个函数，每次遍历会运行该函数            | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-12.png) |
| [Array.prototype.map(fn)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/map)             | 数组映射，传入一个函数，映射数组中的每一项             | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-11.png) |
| [Array.prototype.filter(fn)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/filter)       | 数组筛选，传入一个函数，仅保留满足条件的项             | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-10.png) |
| [Array.prototype.reduce(fn)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce)       | 数组聚合，传入一个函数，对数组每一项按照该函数的返回聚合      | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-9.png)  |
| [Array.prototype.some(fn)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/some)           | 传入一个函数，判断数组中是否有至少一个通过该函数测试的项      | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-5.png)  |
| [Array.prototype.every(fn)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/every)         | 传入一个函数，判断数组中是否所有项都能通过该函数的测试       | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-8.png)  |
| [Array.prototype.find(fn)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/find)           | 传入一个函数，找到数组中第一个能通过该函数测试的项         | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-7.png)  |
| [Array.prototype.includes(item)](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/includes) | 判断数组中是否存在item，判定规则使用的是`Object.is` | ![](/img/user/02_Javascript/attachments/Paste-image-20250812-6.png)  |
...
# 事件循环-原理
[[浏览器/事件循环 Event Loop\|事件循环 Event Loop]]

# Promise基础
[[04_笔面试题详细版/Promise/01. Promise基础/Promise基础\|Promise基础]]

# Promise的链式调用
[[04_笔面试题详细版/Promise/02. Promise的链式调用/Promise的链式调用\|Promise的链式调用]]

# Promise的静态方法
[[04_笔面试题详细版/Promise/03. Promise的静态方法/Promise的静态方法\|Promise的静态方法]]

# async和await
[[04_笔面试题详细版/Promise/04. async和await/async和await\|async和await]]

# Promise相关面试题
[[04_笔面试题详细版/Promise/05. Promise相关面试题/Promise相关面试题\|Promise相关面试题]]
